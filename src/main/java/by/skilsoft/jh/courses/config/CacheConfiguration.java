...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, by.skilsoft.jh.courses.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, by.skilsoft.jh.courses.repository.UserRepository.USERS_BY_EMAIL_CACHE);
