...
public class PublicUserResource {
    ...
    public PublicUserResource(UserService userService, HTTPService httpService) {
        this.httpService = httpService;
        this.userService = userService;
    }

    @GetMapping("/check-admins-access")
    public ResponseEntity<Boolean> checkAdminsAccess() {
    ...
    @GetMapping("/get-entries-for-user/{entityName}")
    public ResponseEntity<List<PermissionForObject>> getEntriesForUser(
        @PathVariable(value = "entityName", required = true) final String entityName
    ) {
        return ResponseEntity.ok(httpService.getEntityIds(entityName));
    }
